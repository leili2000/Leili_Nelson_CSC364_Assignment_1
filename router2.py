...
print("Router 3 socket created")
soc3.connect((host, port3))
## ...
soc4 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
print("Router 4 socket created")
soc4.connect((host, port4))
